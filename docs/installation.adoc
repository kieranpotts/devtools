...
Now, if you login to VS Code using your GitHub account, and if you enable Settings Sync in VS Code, your local VS Code settings will be automatically loaded into every virtual GitHub Codespace you create - ensuring a consistent user experience between cloud and local instances of VS Code.
